...
bool FrontEnd::ImportBBOXFromFile(){
    ...
    std::string current_bbox_file = "/home/fbb/multisensor/ESFK4.2_ws/src/lidar_localization/bbox/0042/bbox_result"
                                                        + std::to_string(current_index) +".txt";
    std::string current_bbox_scores_file  = "/home/fbb/multisensor/ESFK4.2_ws/src/lidar_localization/bbox/0042/scores/"
                                                        + std::to_string(current_index) +".txt";
