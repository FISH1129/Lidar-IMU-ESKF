...
void ScanContext::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<ScanContext *>(to)->MergeFrom(
      static_cast<const ScanContext &>(from));
}
...
void ScanContexts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<ScanContexts *>(to)->MergeFrom(
      static_cast<const ScanContexts &>(from));
}
