...
void RingKey::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<RingKey *>(to)->MergeFrom(
      static_cast<const RingKey &>(from));
}
...
void RingKeys::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<RingKeys *>(to)->MergeFrom(
      static_cast<const RingKeys &>(from));
}
