...
class ViewerFlow {
  ...
  private:
    ...
    std::shared_ptr<OdometrySubscriber> transformed_laser_odom_sub_ptr_;
    std::shared_ptr<OdometrySubscriber> transformed_fused_odom_sub_ptr_;
    ...
    std::deque<PoseData> transformed_laser_odom_buff_;
    std::deque<PoseData> transformed_fused_odom_buff_;
    std::deque<KeyFrame> key_frame_buff_;
    std::deque<KeyFrame> optimized_key_frames_;
    std::deque<KeyFrame> all_key_frames_;

    CloudData current_cloud_data_;
    PoseData current_transformed_laser_odom_;
    PoseData current_transformed_fused_odom_;
};
}
