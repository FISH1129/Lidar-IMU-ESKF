...
{
public:
  BackEndFlow(ros::NodeHandle& nh, std::string cloud_topic, std::string laser_odom_topic, std::string fused_odom_topic);
...
private:
  ...
  // std::shared_ptr<OdometryPublisher> transformed_laser_odom_pub_ptr_;
  std::shared_ptr<OdometryPublisher> transformed_fused_odom_pub_ptr_;
