...
class KeyFrame final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::scan_context_io::Quat* release_q();
  ...
  PROTOBUF_MUST_USE_RESULT ::scan_context_io::Trans* release_t();
...
inline void KeyFrame::set_allocated_q(::scan_context_io::Quat* q) {
  ...
  if (q) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::scan_context_io::Quat>::GetOwningArena(q);
...
inline void KeyFrame::set_allocated_t(::scan_context_io::Trans* t) {
  ...
  if (t) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::scan_context_io::Trans>::GetOwningArena(t);
    if (message_arena != submessage_arena) {
